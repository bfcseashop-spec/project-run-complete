...
const initialData: BillingRecord[] = [
  { id: "BIL-001", patient: "Sarah Johnson", service: "Lab Test + Consultation", amount: 350, discount: 20, tax: 16.5, total: 346.5, paid: 346.5, due: 0, date: "2026-03-19", status: "completed", method: "Cash",
    formData: { patient: "Sarah Johnson", doctor: "Dr. Sarah Smith", date: "2026-03-19", service: "Consultation", injection: "", packageItem: "", medicines: [], customItems: [], discount: 20, discountType: "flat" as const, paidAmount: 346.5, paymentMethod: "Cash", splitPayments: [], lineItems: [li("s1","SVC","Consultation",150,1), li("s2","SVC","Lab Test - CBC",200,1)] } },
  { id: "BIL-002", patient: "Michael Chen", service: "X-Ray", amount: 200, discount: 0, tax: 10, total: 210, paid: 100, due: 110, date: "2026-03-18", status: "pending", method: "Card",
    formData: { patient: "Michael Chen", doctor: "Dr. Raj Patel", date: "2026-03-18", service: "X-Ray", injection: "", packageItem: "", medicines: [], customItems: [], discount: 0, discountType: "flat" as const, paidAmount: 100, paymentMethod: "Card", splitPayments: [], lineItems: [li("s3","SVC","X-Ray - Chest PA",200,1)] } },
  { id: "BIL-003", patient: "Emily Davis", service: "Ultrasound + Injection", amount: 480, discount: 30, tax: 22.5, total: 472.5, paid: 0, due: 472.5, date: "2026-03-17", status: "critical", method: "—",
    formData: { patient: "Emily Davis", doctor: "Dr. Emily Williams", date: "2026-03-17", service: "Ultrasound", injection: "Vitamin B12", packageItem: "", medicines: [], customItems: [], discount: 30, discountType: "flat" as const, paidAmount: 0, paymentMethod: "—", splitPayments: [], lineItems: [li("s4","SVC","Ultrasound - Abdomen",300,1), li("i1","INJ","Vitamin B12",180,1)] } },
  { id: "BIL-004", patient: "James Wilson", service: "Health Checkup", amount: 150, discount: 0, tax: 7.5, total: 157.5, paid: 157.5, due: 0, date: "2026-03-16", status: "completed", method: "Cash",
    formData: { patient: "James Wilson", doctor: "Dr. Mark Brown", date: "2026-03-16", service: "", injection: "", packageItem: "Health Checkup", medicines: [], customItems: [], discount: 0, discountType: "flat" as const, paidAmount: 157.5, paymentMethod: "Cash", splitPayments: [], lineItems: [li("p1","PKG","Health Checkup",150,1)] } },
  ...
  { id: "BIL-006", patient: "Sopheap Ly", service: "Consultation", amount: 120, discount: 0, tax: 6, total: 126, paid: 126, due: 0, date: "2026-03-21", status: "completed", method: "ACleda",
    formData: { patient: "Sopheap Ly", doctor: "Dr. Sarah Smith", date: "2026-03-21", service: "Consultation", injection: "", packageItem: "", medicines: [], customItems: [], discount: 0, discountType: "flat" as const, paidAmount: 126, paymentMethod: "ACleda", splitPayments: [], lineItems: [li("s6","SVC","Consultation",120,1)] } },
  { id: "BIL-007", patient: "Channary Kim", service: "Lab Test", amount: 250, discount: 15, tax: 11.75, total: 246.75, paid: 246.75, due: 0, date: "2026-03-21", status: "completed", method: "ABA",
    formData: { patient: "Channary Kim", doctor: "Dr. Raj Patel", date: "2026-03-21", service: "", injection: "", packageItem: "", medicines: [], customItems: [], discount: 15, discountType: "flat" as const, paidAmount: 246.75, paymentMethod: "ABA", splitPayments: [], lineItems: [li("s7","SVC","Lab Test - CBC",120,1), li("s8","SVC","Lab Test - Lipid Panel",130,1)] } },
  ...
  { id: "BIL-009", patient: "Sokha Phan", service: "X-Ray + Consultation", amount: 320, discount: 20, tax: 15, total: 315, paid: 315, due: 0, date: "2026-03-20", status: "completed", method: "Card",
    formData: { patient: "Sokha Phan", doctor: "Dr. Mark Brown", date: "2026-03-20", service: "X-Ray", injection: "", packageItem: "", medicines: [], customItems: [], discount: 20, discountType: "flat" as const, paidAmount: 315, paymentMethod: "Card", splitPayments: [], lineItems: [li("s9","SVC","X-Ray - Chest PA",200,1), li("s10","SVC","Consultation",120,1)] } },
  { id: "BIL-010", patient: "Vanna Sok", service: "Ultrasound", amount: 280, discount: 0, tax: 14, total: 294, paid: 0, due: 294, date: "2026-03-20", status: "critical", method: "—",
    formData: { patient: "Vanna Sok", doctor: "Dr. Lisa Lee", date: "2026-03-20", service: "Ultrasound", injection: "", packageItem: "", medicines: [], customItems: [], discount: 0, discountType: "flat" as const, paidAmount: 0, paymentMethod: "—", splitPayments: [], lineItems: [li("s11","SVC","Ultrasound - Abdomen",280,1)] } },
];
